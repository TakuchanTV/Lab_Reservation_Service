...
interface Props {
 ...
 export const ReservationPage12 = () => {
  const navigate = useNavigate();
  const [params, setParams] = useSearchParams();
  const text23 = params.get('q') || '';
    const text24 = params.get('r') || '';
    const SelectColor12 = params.get('color') || '';
   ...
   const okButton = () => {
    if(text23 === "" && text24 === "" && SelectColor12 === "") {
      ...
      <div>
        <div>
          ...
          <table border={1}   color="bule">
            ...
            <STr>
               <STh>予約対象</STh>  <td>{Ids.autograph}</td>
            </STr>
            <STr>
               <STh>テキスト</STh>  <td><SInput type="text" value={text23} 
            onChange={textInput} /></td>
            </STr>
            <STr>
               <STh>予約者（登録者）</STh>  <td><SInput id="text2" type="text" value={text24} 
               onChange={textInput2} /></td>
            </STr>
            <STr>
               <STh>色</STh> <td><input type="color" value={SelectColor12}  
