...
import { SelectDays } from "../ReservCustomhooks/SelectDays";
 ...
 export const ReservationPage9 = () => {
  const navigate = useNavigate();
  const [params, setParams] = useSearchParams();
  const text17 = params.get('q') || '';
    const text18 = params.get('r') || '';
    const SelectColor9 = params.get('color') || '';
      ...
      <div>
        <div>
          ...
          <table border={1}   color="bule">
            ...
            <STr>
               <STh>予約対象</STh>  <td>{Ids.rightVacuum}</td>
            </STr>
            <STr>
               <STh>テキスト</STh>  <td><SInput type="text" value={text17} 
            onChange={textInput} /></td>
            </STr>
            <STr>
               <STh>予約者（登録者）</STh>  <td><SInput id="text2" type="text" value={text18} 
               onChange={textInput2} /></td>
            </STr>
            <STr>
               <STh>色</STh> <td><input type="color" value={SelectColor9}  
